...
For more information about the API: [MpesaFlow Documentation](https://docs.mpesaflow.com/api-reference/v1)
<!-- End Summary [summary] -->
...
```sh
npx -y --package mpesaflow -- mcp start --help
```
...
* [delete](docs/sdks/customers/README.md#delete) - Remove a customer

### [darajaPayment](docs/sdks/darajapayment/README.md)

* [mpesaPay](docs/sdks/darajapayment/README.md#mpesapay) - Initiate M-Pesa payment
...
* [delete](docs/sdks/products/README.md#delete) - Remove a product

### [transactions](docs/sdks/transactions/README.md)

* [list](docs/sdks/transactions/README.md#list) - List of all transactions
...
* [delete](docs/sdks/transactions/README.md#delete) - Remove a transaction
...
- [`customersDelete`](docs/sdks/customers/README.md#delete) - Remove a customer
- [`customersGet`](docs/sdks/customers/README.md#get) - Get a customer
- [`customersList`](docs/sdks/customers/README.md#list) - List of all customers
- [`customersUpdate`](docs/sdks/customers/README.md#update) - Update a customer
- [`darajaPaymentMpesaPay`](docs/sdks/darajapayment/README.md#mpesapay) - Initiate M-Pesa payment
- [`productsCreate`](docs/sdks/products/README.md#create) - Create a product
- [`productsDelete`](docs/sdks/products/README.md#delete) - Remove a product
- [`productsGet`](docs/sdks/products/README.md#get) - Get a product
- [`productsList`](docs/sdks/products/README.md#list) - List of all products
...
- [`transactionsDelete`](docs/sdks/transactions/README.md#delete) - Remove a transaction
- [`transactionsGet`](docs/sdks/transactions/README.md#get) - Get a transaction
- [`transactionsList`](docs/sdks/transactions/README.md#list) - List of all transactions
...
async function run() {
  let result;
  try {
    result = await mpesaFlow.products.list({});
    ...
    switch (true) {
      ...
      case (err instanceof GetProductsBadRequestError): {
        // Handle err.data$: GetProductsBadRequestErrorData
        console.error(err);
        return;
      }
      case (err instanceof GetProductsUnauthorizedError): {
        // Handle err.data$: GetProductsUnauthorizedErrorData
        console.error(err);
        return;
      }
      case (err instanceof GetProductsNotFoundError): {
        // Handle err.data$: GetProductsNotFoundErrorData
        console.error(err);
        return;
      }
...
const mpesaFlow = new MpesaFlow({
  serverURL: "https://api.mpesaflow.com/v1",
  bearer: process.env["MPESAFLOW_BEARER"] ?? "",
});
